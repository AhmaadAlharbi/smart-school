...
class AddParent extends Component
{
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'National_ID_Father' =>  'required|unique:my__parents,National_ID_Mother,' . $this->id,
            'Passport_ID_Father' =>  'required|unique:my__parents,National_ID_Mother,' . $this->id,
    ...
    public function secondStepSubmit(){
        $this->validate([
            ...
            'National_ID_Father' => [
                'sometimes',
                'required',
                'unique:my__parents,National_ID_Mother,' . $this->Parent_id,
            ],
            'Passport_ID_Father' => [
                'sometimes',
                'required',
                'unique:my__parents,Passport_ID_Mother,' . $this->Parent_id,
            ],
            'Phone_Father' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:10',
            'Nationality_Father_id' => 'required',
            'Blood_Type_Father_id' => 'required',
...
//            }
    ...
    public function confirmDeletion($parentId)
    {
        $this->emit('showDeleteConfirmation', $parentId);
    }
    protected $listeners = ['delete'];

    public function delete($id)
    {
        //do not foreget to delete attahcments
