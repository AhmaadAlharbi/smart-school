                    ...
                    <div class="header-right">
                        ...
                        <div class="header-nav-right">
                            ...
                            <button aria-label="button" type="button" data-hs-overlay="#search-modal"
                                class="inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium bg-gray-100 hover:bg-gray-200 text-gray-500 align-middle focus:outline-none focus:ring-0 focus:ring-gray-400 focus:ring-offset-0 focus:ring-offset-white transition-all text-xs">
                            ...
                            <button id="dropdown-cart" type="button" class="hs-dropdown-toggle ti-dropdown-toggle p-0 border-0 flex-shrink-0 h-[2.375rem] w-[2.375rem] rounded-full shadow-none focus:ring-gray-400 text-xs">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 fill-headerprime" height="24px"
                                viewBox="0 0 24 24" width="24px" fill="#000000">
                                <path d="M0 0h24v24H0V0z" fill="none"></path>
                            ...
                            <div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-cart">
                                <div class="ti-dropdown-header !bg-primary border-b flex justify-between items-center">
                                ...
                                <div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
                                    ...
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                        ...
                                        class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 !ring-transparent">
                                        <div>
                                        ...
                                        <div class="flex space-x-2 rtl:space-x-reverse">
                                            ...
                                            <span class="my-auto line-through text-xs text-gray-400">$999</span>
                                        </div>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);"
                                        class="header-remove-btn ltr:ml-auto rtl:mr-auto flex-shrink-0 inline-flex items-center justify-center text-lg text-gray-500/20 hover:text-gray-800">
                                    ...
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                        ...
                                        <div class="flex space-x-2 rtl:space-x-reverse">
                                            ...
                                            <span class="my-auto line-through text-xs text-gray-400">$599</span>
                                        </div>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);"
                                    ...
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                        ...
                                        <div class="flex space-x-2 rtl:space-x-reverse">
                                            ...
                                            <span class="my-auto line-through text-xs text-gray-400">$399</span>
                                        </div>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);"
                                    ...
                                    <a href="{{url('cart')}}" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                        ...
                                        <div class="flex space-x-2 rtl:space-x-reverse">
                                            ...
                                            <span class="my-auto line-through text-xs text-gray-400">$150</span>
                                        </div>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);"
                                ...
                                <div class="py-2 first:pt-0 last:pb-0 px-5">
                                    ...
                                    <div class="text-end font-medium">
                                        <span class="text-xs font-semibold text-gray-800">$40,020</span>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <button id="dropdown-notification" type="button"
                                class="hs-dropdown-toggle ti-dropdown-toggle p-0 border-0 flex-shrink-0 h-[2.375rem] w-[2.375rem] rounded-full shadow-none focus:ring-gray-400 text-xs">
                            ...
                            <div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-notification">
                                ...
                                <div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                                    ...
                                    <a href="{{url('mail-inbox')}}" class="flex space-x-3 rtl:space-x-reverse">
                                        ...
                                        <h5 class="text-sm text-gray-800 font-semibold mb-1">Elon Isk</h5>
                                        <p class="text-xs mb-1 max-w-[200px] truncate">Hello there! How are you doing? Call me when...</p>
                                        <p class="text-xs text-gray-400">2 min</p>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);" class="header-remove-btn ltr:ml-auto rtl:mr-auto text-lg text-gray-500/20 hover:text-gray-800">
                                        <i class="ri-close-circle-line"></i>
                                    </a>
                                    </div>
                                    <div class="ti-dropdown-item relative header-box">
                                    <a href="{{url('mail-inbox')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div class="relative w-full">
                                        <h5 class="text-sm text-gray-800 font-semibold mb-1">Shakira Sen</h5>
                                        <p class="text-xs mb-1 max-w-[200px] truncate">I would like to discuss about that assets...</p>
                                        <p class="text-xs text-gray-400">09:43</p>
                                        </div>
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);" class="header-remove-btn ltr:ml-auto rtl:mr-auto text-lg text-gray-500/20 hover:text-gray-800">
                                        <i class="ri-close-circle-line"></i>
                                    ...
                                    <a href="{{url('mail-inbox')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div class="relative w-full">
                                        <h5 class="text-sm text-gray-800 font-semibold mb-1">Sebastian</h5>
                                    ...
                                    <a href="{{url('mail-inbox')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div class="relative w-full">
                                        <h5 class="text-sm text-gray-800 font-semibold mb-1">Charlie Davieson</h5>
                            ...
                            <div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-apps">
                                <div
                                class="ti-dropdown-header !bg-primary border-b flex justify-between items-center text-center">
                                <p class="ti-dropdown-header-title font-semibold !text-white">Related Apps</p>
                                </div>
                                <div class="ti-dropdown-divider divide-y divide-gray-200">
                                <div class="grid grid-cols-3 gap-0 p-4 pt-2">
                                    <a href="{{url('mail-inbox')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">Mail Inbox</div>
                                    </a>
                                    <a href="{{url('chat')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">Chat</div>
                                    </a>
                                    <a href="{{url('tasks')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">Task</div>
                                    </a>
                                    <a href="{{url('calendar')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">Calendar</div>
                                    </a>
                                    <a href="{{url('filemanager')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">FileManager</div>
                                    </a>
                                    <a href="{{url('contacts')}}" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                                    ...
                                    <div class="text-xs font-semibold text-gray-800">Contacts</div>
                                    </a>
                                </div>
                                <div class="py-2 first:pt-0 px-5">
                            ...
                            <button id="dropdown-profile" type="button"
                                class="hs-dropdown-toggle ti-dropdown-toggle gap-2 p-0 flex-shrink-0 h-8 w-8 rounded-full shadow-none focus:ring-gray-400 text-xs">
