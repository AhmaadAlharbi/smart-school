            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"> <a class="side-menu__item"
                                href="{{route('promotion.index')}}">{{trans('main_trans.add_Promotion')}}</a></li>
                        <li class="slide"> <a class="side-menu__item"
                                href="{{route('promotion.create')}}">{{trans('main_trans.list_Promotions')}}</a> </li>
                    </ul>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{url('advanced-forms')}}" class="side-menu__item">AdvancedForms</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{url('draggable')}}" class="side-menu__item">Draggable Cards</a>
                        </li>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Tables<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('datatables')}}" class="side-menu__item">DataTables</a>
                                </li>
                                <li class="slide"><a href="{{url('edittable')}}" class="side-menu__item">Edit Table</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{url('leaflet-maps')}}" class="side-menu__item">Leaflet Maps</a>
                        </li>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Blog<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('blog-edit')}}" class="side-menu__item">Edit Blog</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Ecommerce<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('edit-product')}}" class="side-menu__item">Edit
                                        Product</a>
                                </li>
                                <li class="slide"><a href="{{url('products-details')}}"
                                        class="side-menu__item">Products-Details</a>
                                </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{url('tabler-icons')}}" class="side-menu__item">Tabler Icons</a>
                        </li>
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-In<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('signin-cover')}}" class="side-menu__item">Cover-1</a>
                                </li>
                                <li class="slide"><a href="{{url('signin-cover2')}}" class="side-menu__item">Cover-2</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-Up<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('signup-cover')}}" class="side-menu__item">Cover-1</a>
                                </li>
                                <li class="slide"><a href="{{url('signup-cover2')}}" class="side-menu__item">Cover-2</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Create
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{url('createpassword')}}" class="side-menu__item">Basic</a>
                                </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Forgot
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('forgot-cover')}}" class="side-menu__item">Cover-1</a>
                                </li>
                                <li class="slide"><a href="{{url('forgot-cover2')}}" class="side-menu__item">Cover-2</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Reset Password<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('reset-cover2')}}" class="side-menu__item">Cover-2</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two-Step
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{url('verfication-cover2')}}"
                                        class="side-menu__item">Cover-2</a>
                                </li>
                            </ul>
                        </li>
                        <li class="slide"><a href="{{url('maintenance')}}" class="side-menu__item">Under Maintenance</a>
                        </li>
                        <li class="slide"><a href="{{url('construction')}}" class="side-menu__item">Under
                                Construction</a>
                        </li>
