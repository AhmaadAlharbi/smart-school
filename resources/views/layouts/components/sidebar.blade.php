            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">{{ trans('main_trans.Teachers') }}</span>
                        <i class="ri ri-arrow-right-s-line side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">

                        <li class="slide"><a href="{{ route('teachers.index') }}" class="side-menu__item">{{
                                trans('main_trans.List_Teachers') }}</a></li>

                        <li class="slide"> <a class="side-menu__item" href="{{ route('teachers.create') }}">{{
                                trans('main_trans.add_teacher') }}</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('accordion') }}" class="side-menu__item">Accordion</a>
                        </li>
                        ...
                        <li class="slide"><a href="{{ url('list-group') }}" class="side-menu__item">ListGroup</a>
                        </li>
                        <li class="slide"><a href="{{ url('list-page') }}" class="side-menu__item">List</a></li>
                        <li class="slide"><a href="{{ url('indicators') }}" class="side-menu__item">Indicators</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('mega-menu') }}" class="side-menu__item">Mega Menu</a>
                        </li>
                        <li class="slide"><a href="{{ url('tabs') }}" class="side-menu__item">Nav &amp;Tabs</a>
                        </li>
                        <li class="slide"><a href="{{ url('scrollspy') }}" class="side-menu__item">Scrollspy</a>
                        </li>
                        <li class="slide"><a href="{{ url('breadcrumb') }}" class="side-menu__item">Breadcrumb</a>
                        </li>
                        <li class="slide"><a href="{{ url('pagination') }}" class="side-menu__item">Pagination</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('sweetalert') }}" class="side-menu__item">Sweetalert</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('offcanvas') }}" class="side-menu__item">Offcanvas</a>
                        </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Tables<i
                            ...
                            <ul class="slide-menu child2">
                                ...
                                <li class="slide"><a href="{{ url('edittable') }}" class="side-menu__item">Edit
                                        Table</a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('google-maps') }}" class="side-menu__item">Google
                                Maps</a></li>
                        <li class="slide"><a href="{{ url('leaflet-maps') }}" class="side-menu__item">Leaflet
                                Maps</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Profile<i
                                    class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{ url('profile') }}" class="side-menu__item">Home</a>
                                </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Blog<i
                                    class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{ url('blog') }}" class="side-menu__item">Blog</a>
                                </li>
                                <li class="slide"><a href="{{ url('blog-details') }}" class="side-menu__item">Blog
                                        Details</a>
                                </li>
                                <li class="slide"><a href="{{ url('blog-edit') }}" class="side-menu__item">Edit
                                        Blog</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide"><a href="{{ url('contacts') }}" class="side-menu__item">Contacts</a>
                        </li>
                        <li class="slide"><a href="{{ url('pricing') }}" class="side-menu__item">Pricing
                                tables</a></li>
                        <li class="slide"><a href="{{ url('timeline') }}" class="side-menu__item">Timeline</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ url('tabler-icons') }}" class="side-menu__item">Tabler
                                Icons</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-In<i
                                    class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{ url('signin') }}" class="side-menu__item">Basic</a>
                                </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-Up<i
                                    class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{ url('signup') }}" class="side-menu__item">Basic</a>
                                </li>
                        ...
                        <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Forgot
                                Password<i class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                            <ul class="slide-menu child2">
                                <li class="slide"><a href="{{ url('forgot') }}" class="side-menu__item">Basic</a>
                                </li>
