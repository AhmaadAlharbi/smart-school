                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('index2')}}" class="side-menu__item">Ecommerce</a></li>
                                    ...
                                    <li class="slide"><a href="{{url('index6')}}" class="side-menu__item">Analytics</a></li>
                                    <li class="slide"><a href="{{url('index7')}}" class="side-menu__item">Projects</a></li>
                                    ...
                                    <li class="slide"><a href="{{url('index10')}}" class="side-menu__item">Personal</a></li>
                                    <li class="slide"><a href="{{url('index11')}}" class="side-menu__item">Stocks</a></li>
                                    <li class="slide"><a href="{{url('index12')}}" class="side-menu__item">Course</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('navbar')}}" class="side-menu__item">Navbar</a></li>
                                    <li class="slide"><a href="{{url('mega-menu')}}" class="side-menu__item">Mega Menu</a></li>
                                    <li class="slide"><a href="{{url('tabs')}}" class="side-menu__item">Nav &amp;Tabs</a></li>
                                    <li class="slide"><a href="{{url('scrollspy')}}" class="side-menu__item">Scrollspy</a></li>
                                    <li class="slide"><a href="{{url('breadcrumb')}}" class="side-menu__item">Breadcrumb</a></li>
                                    <li class="slide"><a href="{{url('pagination')}}" class="side-menu__item">Pagination</a></li>
                                    <li class="slide"><a href="{{url('grid')}}" class="side-menu__item">Grids</a></li>
                                    <li class="slide"><a href="{{url('columns')}}" class="side-menu__item"> Columns</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('advanced-forms')}}" class="side-menu__item">AdvancedForms</a></li>
                                    <li class="slide"><a href="{{url('form-inputgroup')}}" class="side-menu__item">Form-Input-Group</a></li>
                                    <li class="slide"><a href="{{url('file-upload')}}" class="side-menu__item">File Uploads</a></li>
                                    <li class="slide"><a href="{{url('form-checkbox')}}" class="side-menu__item">Form-Checkbox</a></li>
                                    <li class="slide"><a href="{{url('form-radio')}}" class="side-menu__item">Form-Radio</a></li>
                                    <li class="slide"><a href="{{url('form-switch')}}" class="side-menu__item">Form-Switch</a></li>
                                    <li class="slide"><a href="{{url('form-select')}}" class="side-menu__item">Form-Select</a></li>
                                    <li class="slide"><a href="{{url('form-layouts')}}" class="side-menu__item">Form-Layouts</a></li>
                                    <li class="slide"><a href="{{url('form-validations')}}" class="side-menu__item">Form-Validations</a></li>
                                    <li class="slide"><a href="{{url('quil-editor')}}" class="side-menu__item">Form-Editor</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('rangeslider')}}" class="side-menu__item">Rangeslider</a></li>
                                    ...
                                    <li class="slide"><a href="{{url('sweetalert')}}" class="side-menu__item">Sweetalert</a></li>
                                    <li class="slide"><a href="{{url('ratings')}}" class="side-menu__item">Rating</a></li>
                                    <li class="slide"><a href="{{url('draggable')}}" class="side-menu__item">Draggable Cards</a></li>
                                    <li class="slide"><a href="{{url('notifications')}}" class="side-menu__item">Notifications</a></li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">File Manger<i
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('filemanager')}}" class="side-menu__item">File Manger</a>
                                            </li>
                                            <li class="slide"><a href="{{url('filemanager-list')}}" class="side-menu__item">File Manger
                                                    List</a></li>
                                            <li class="slide"><a href="{{url('file-details')}}" class="side-menu__item">File Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('dropdown')}}" class="side-menu__item">Dropdown</a></li>
                                    <li class="slide"><a href="{{url('modal')}}" class="side-menu__item">Modal</a></li>
                                    <li class="slide"><a href="{{url('offcanvas')}}" class="side-menu__item">Offcanvas</a></li>
                                    <li class="slide"><a href="{{url('tooltip-popovers')}}" class="side-menu__item">Tooltips &amp;
                                            Popovers</a></li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Tables<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('tables')}}" class="side-menu__item">BasicTables</a></li>
                                            <li class="slide"><a href="{{url('datatables')}}" class="side-menu__item">DataTables</a></li>
                                            <li class="slide"><a href="{{url('edittable')}}" class="side-menu__item">Edit Table</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('echartjs')}}" class="side-menu__item">EchartJs</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Profile<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('profile')}}" class="side-menu__item">Home</a></li>
                                            <li class="slide"><a href="{{url('profile-settings')}}" class="side-menu__item">Profile
                                                    Settings</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Invoice<i
                                        ...
                                        <ul class="slide-menu child2">
                                            ...
                                            <li class="slide"><a href="{{url('invoice')}}" class="side-menu__item">Invoice Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Blog<i
                                        ...
                                        <ul class="slide-menu child2">
                                            ...
                                            <li class="slide"><a href="{{url('blog-details')}}" class="side-menu__item">Blog Details</a>
                                            </li>
                                            <li class="slide"><a href="{{url('blog-edit')}}" class="side-menu__item">Edit Blog</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Mail<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('mail-inbox')}}" class="side-menu__item">Mail</a></li>
                                            <li class="slide"><a href="{{url('chat')}}" class="side-menu__item">Chat</a></li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Ecommerce<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('products')}}" class="side-menu__item">Products</a></li>
                                            <li class="slide"><a href="{{url('product-list')}}" class="side-menu__item">Product list</a>
                                            </li>
                                            <li class="slide"><a href="{{url('add-product')}}" class="side-menu__item">Add Product</a>
                                            </li>
                                            <li class="slide"><a href="{{url('edit-product')}}" class="side-menu__item">Edit Product</a>
                                            </li>
                                            <li class="slide"><a href="{{url('products-details')}}" class="side-menu__item">Products-Details</a></li>
                                            <li class="slide"><a href="{{url('cart')}}" class="side-menu__item">Cart</a></li>
                                            <li class="slide"><a href="{{url('checkout')}}" class="side-menu__item">Checkout</a></li>
                                            <li class="slide"><a href="{{url('orders')}}" class="side-menu__item">Orders</a></li>
                                            <li class="slide"><a href="{{url('order-details')}}" class="side-menu__item">Order Details</a>
                                            </li>
                                            <li class="slide"><a href="{{url('wishlist')}}" class="side-menu__item">Whislist</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide"><a href="{{url('about')}}" class="side-menu__item">About Us</a></li>
                                    <li class="slide"><a href="{{url('contacts')}}" class="side-menu__item">Contacts</a></li>
                                    <li class="slide"><a href="{{url('pricing')}}" class="side-menu__item">Pricing tables</a></li>
                                    <li class="slide"><a href="{{url('timeline')}}" class="side-menu__item">Timeline</a></li>
                                    <li class="slide"><a href="{{url('teams')}}" class="side-menu__item">Team</a></li>
                                    <li class="slide"><a href="{{url('landing')}}" class="side-menu__item">Landing</a></li>
                                    <li class="slide"><a href="{{url('todo')}}" class="side-menu__item">Todo list</a></li>
                                    <li class="slide"><a href="{{url('tasks')}}" class="side-menu__item">Tasks</a></li>
                                    ...
                                    <li class="slide"><a href="{{url('empty-page')}}" class="side-menu__item">Empty Page</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide"><a href="{{url('tabler-icons')}}" class="side-menu__item">Tabler Icons</a></li>
                                    <li class="slide"><a href="{{url('remix-icons')}}" class="side-menu__item">Remix Icons</a></li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <li class="slide has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-In<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('signin')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('signin-cover')}}" class="side-menu__item">Cover-1</a></li>
                                            <li class="slide"><a href="{{url('signin-cover2')}}" class="side-menu__item">Cover-2</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Sign-Up<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('signup')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('signup-cover')}}" class="side-menu__item">Cover-1</a></li>
                                            <li class="slide"><a href="{{url('signup-cover2')}}" class="side-menu__item">Cover-2</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Create
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('createpassword')}}" class="side-menu__item">Basic</a></li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Forgot
                                            Password<i class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('forgot')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('forgot-cover')}}" class="side-menu__item">Cover-1</a></li>
                                            <li class="slide"><a href="{{url('forgot-cover2')}}" class="side-menu__item">Cover-2</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Reset Password<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('reset')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('reset-cover')}}" class="side-menu__item">Cover-1</a></li>
                                            <li class="slide"><a href="{{url('reset-cover2')}}" class="side-menu__item">Cover-2</a></li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Lockscreen<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('lockscreen')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('lockscreen-cover')}}" class="side-menu__item">Cover-1</a>
                                            </li>
                                            <li class="slide"><a href="{{url('lockscreen-cover2')}}" class="side-menu__item">Cover-2</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two-Step
                                        ...
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('verfication')}}" class="side-menu__item">Basic</a></li>
                                            <li class="slide"><a href="{{url('verfication-cover')}}" class="side-menu__item">Cover-1</a>
                                            </li>
                                            <li class="slide"><a href="{{url('verfication-cover2')}}" class="side-menu__item">Cover-2</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="slide"><a href="{{url('maintenance')}}" class="side-menu__item">Under Maintenance</a></li>
                                    <li class="slide"><a href="{{url('construction')}}" class="side-menu__item">Under Construction</a>
                                    </li>
                                    ...
                                    <li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Error Pages<i
                                                class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
                                        <ul class="slide-menu child2">
                                            <li class="slide"><a href="{{url('error404')}}" class="side-menu__item">404Error</a></li>
                                            <li class="slide"><a href="{{url('error500')}}" class="side-menu__item">500Error</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
