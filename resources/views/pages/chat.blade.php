                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Chat</h3>
                                </div>
                            ...
                            <div class="main-chart-wrapper px-5 gap-2 lg:flex">
                                <div class="chat-info">
                                    ...
                                    <div class="box-body px-0 pb-0">
                                        ...
                                        <div class="chat-active space-y-3 pb-6 px-6 border-b border-gray-200">
                                            <h3 class="text-gray-800 font-semibold">Active</h3>
                                        ...
                                        <div class="chat-message">
                                            ...
                                            <h3 class="text-gray-800 font-semibold">Messages</h3>
                                            <div class="text-center">
                                                <nav
                                                class="flex justify-center bg-gray-100 p-2 mx-auto w-full rounded-sm gap-2"
                                                aria-label="Tabs" role="tablist">
                                                <button type="button"
                                                    class="w-full hs-tab-active:!bg-primary hs-tab-active:!text-white -mb-px p-2 items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-sm hover:text-gray-700 active"
                                                    id="messages-1" data-hs-tab="#messages-style-1" aria-controls="messages-style-1" role="tab">
                                                    <i class="ti ti-mail"></i> Chat
                                                </button>
                                                <button type="button"
                                                    class="w-full hs-tab-active:!bg-primary hs-tab-active:!text-white -mb-px p-2 items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-sm hover:text-gray-700"
                                            ...
                                            <div id="messages-style-1" role="tabpanel" aria-labelledby="messages-1">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">5mins ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">30mins ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">45mins ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">1hr ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">2hr ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">5hr ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">1day ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <p class="text-gray-500 font-normal text-xs">2day ago</p>
                                                        </div>
                                                        <div class="flex items-center justify-between">
                                                        <p class="text-xs text-gray-500 chat-msg-text">
                                            ...
                                            <div id="messages-style-3" class="hidden" role="tabpanel" aria-labelledby="messages-3">
                                                ...
                                                <li class="ti-list-group border-0 text-gray-800 relative checkforactive">
                                                    ...
                                                    <div class="flex items-center justify-between w-full">
                                                        ...
                                                        <i class="text-base text-gray-500 ti ti-phone-call"></i>
                                                        <i class="text-base text-gray-500 ti ti-video"></i>
                                                        </div>
                                                    </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="main-chat-area">
                                    ...
                                    <div class="box-header bg-transparent">
                                        ...
                                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                            ...
                                            <p class="text-xs text-gray-500 chatpersonstatus">
                                                online
                                            </p>
                                            </div>
                                        </div>
                                        <div class="flex my-auto main-chat-right-icons mt-5 sm:mt-auto">
                                            ...
                                            <div class="cursor-pointer search-chat-icon sm:absolute sm:ltr:right-0 sm:rtl:left-0 ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-500  focus:ring-gray-200   "
                                            >
                                            ...
                                            <a aria-label="anchor" class="ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-500 hover:text-gray-700 hover:bg-gray-100 hover:border-gray-200 focus:ring-gray-200 "
                                            ...
                                            <a aria-label="anchor" class="ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-500 hover:text-gray-700 hover:bg-gray-100 hover:border-gray-200 focus:ring-gray-200  responsive-userinfo-open"
                                            ...
                                            <button aria-label="button" id="hs-dropdown-custom-icon-trigger" type="button"
                                                class="hs-dropdown-toggle ti-dropdown-toggle rounded-full p-2 !border border-gray-200 text-gray-500 hover:text-gray-700 hover:bg-gray-100 hover:border-gray-200 focus:ring-gray-200 ">
                                            ...
                                            <a aria-label="anchor" class="responsive-chat-close ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-400 hover:text-white hover:bg-gray-500 hover:border-gray-200 focus:ring-gray-200 "
                                    ...
                                    <div class="main-chat-content2 chat-content">
                                        ...
                                        <div id="chatlist">
                                            ...
                                            <div class="chat-lable">
                                                <span class="badge bg-gray-100 text-gray-800">Yesterday</span>
                                            </div>
                                            <div class="chat-left">
                                                <div>
                                                ...
                                                <div class="chat-inner-msg space-y-1">
                                                    <span
                                                    class="p-2 rounded-sm inline-block border border-gray-200 bg-primary/20 text-primary">
                                            ...
                                            <div class="chat-right">
                                                ...
                                                <div class="chat-inner-msg">
                                                    <span
                                                    class="p-2 rounded-sm inline-block  border border-gray-200 bg-primary text-white">
                                            ...
                                            <div class="chat-left">
                                                ...
                                                <div class="chat-inner-msg space-y-1">
                                                    <div
                                                    class="p-2 rounded-sm border border-gray-200 bg-primary/20 text-primary flex flex-row items-center">
                                            ...
                                            <div class="chat-lable">
                                                <span class="badge bg-gray-100 text-gray-800">Today</span>
                                            </div>
                                            <div class="chat-right">
                                                <div class="flex flex-col items-end space-y-2">
                                                <div class="chat-inner-msg">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <div class="hidden sm:flex">
                                            <a aria-label="anchor" class="ti-btn px-2 py-1 text-gray-500 bg-gray-100 focus:ring-gray-500"
                                        ...
                                        <div class="flex">
                                            <a aria-label="anchor" class="hidden sm:block ti-btn px-2 py-1 text-gray-500 bg-gray-100 focus:ring-gray-500"
                                ...
                                <div class="chat-user-details" id="chat-user-details">
                                    ...
                                    <a aria-label="anchor" href="javascript:void(0);"
                                        class="user-close z-40 absolute top-2 ltr:right-2 rtl:left-2 block lg:hidden bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i
                                        class="ti ti-x"></i></a>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="text-center space-y-2">
                                                ...
                                                <a href="javascript:void(0);">
                                                    <h5 class="text-slate-700 font-semibold text-base chatnameperson">Airi Satou
                                                    </h5>
                                                </a>
                                                <p class="text-xs text-gray-500 mb-1">UI/UX Designer</p>
                                                <p class="text-xs text-gray-500">+123(45)-158-90.</p>
                                                </div>
                                            </div>
                                            <div class="flex sm:space-x-3 justify-center text-center rtl:space-x-reverse">
                                                <div class="block">
                                                <button aria-label="button" type="button"
                                                    class="ti-btn ti-btn-outline p-2 border-gray-200 text-gray-500 hover:text-white hover:bg-gray-500 hover:border-gray-200 focus:ring-gray-200 ">
                                                ...
                                                <button aria-label="button" id="chat-options" type="button"
                                                    class="hs-dropdown-toggle ti-dropdown-toggle ti-btn ti-btn-outline p-2 border-gray-200 text-gray-500 hover:text-white hover:bg-gray-500 hover:border-gray-200 focus:ring-gray-200 ">
                                            ...
                                            <div class="border p-3 rounded-sm border-gray-200">
                                                <h1 class="font-semibold">About Me</h1>
                                                <p class="mt-2 text-gray-500 text-sm">Lorem ipsum dolor sit amet,
                                                consectetuer adipiscing elit.
                                                Aenean commodo ligula eget dolor. </p>
                                            </div>
                                            <div class="border p-3 rounded-sm border-gray-200 space-y-3">
                                                <div class="">
                                                <nav class="sm:flex sm:space-x-4 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                                    <button type="button"
                                                    class="hs-tab-active:border-primary hs-tab-active:text-primary border-b-[3px] border-transparent py-2 px-1 inline-flex items-center sm:gap-2 text-sm font-medium text-center whitespace-nowrap text-gray-500 hover:text-primary  active"
                                                    ...
                                                    <button type="button"
                                                    class="hs-tab-active:border-primary hs-tab-active:text-primary border-b-[3px] border-transparent py-2 px-1 inline-flex items-center sm:gap-2 text-sm font-medium text-center whitespace-nowrap text-gray-500 hover:text-primary"
                                                ...
                                                <div id="chat-gallery-2" class="hidden" role="tabpanel" aria-labelledby="chat-gallery-item-2">
                                                    ...
                                                    <li
                                                        class="flex flex-col gap-x-3.5 bg-white text-gray-800 py-1 rounded-sm">
                                                        <div class="flex items-center justify-between">
                                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                            <div class="">
                                                            ...
                                                            <p class="text-xs text-gray-500">20MB</p>
                                                            </div>
                                                        </div>
                                                        <div class="space-x-2">
                                                            <a aria-label="anchor" href="javascript:void(0);"><span><i
                                                                class="ti ti-cloud-download text-gray-500 text-lg"></i></span></a>
                                                            ...
                                                            <button aria-label="button" type="button"
                                                                ...
                                                                <i class="text-lg text-gray-500 ti ti-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div id="chat-gallery-3" class="hidden" role="tabpanel" aria-labelledby="chat-gallery-item-3">
                                                    ...
                                                    <div class="flex p-1 space-x-2 rtl:space-x-reverse">
                                                        ...
                                                        <p class="text-gray-500 text-sm">Airisatou@youremail.com</p>
                                                        </div>
                                                    </div>
                                                    <div class="flex p-1 space-x-2 rtl:space-x-reverse">
                                                        <div class="flex-shrink-0 my-auto">
                                                        ...
                                                        <p class="text-gray-500 text-sm">+123(45)-158-90.</p>
                                                        </div>
                                                    </div>
                                                    <div class="flex p-1 space-x-2 rtl:space-x-reverse">
                                                        <div class="flex-shrink-0 my-auto">
                                                        ...
                                                        <p class="text-gray-500 text-sm">2nd street,houston texas,united
                                                            states.</p>
                                                        </div>
                                                    </div>
                                                    </div>
