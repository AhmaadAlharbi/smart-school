                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Skeleton</h3>
                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                <div class="col-span-12 lg:col-span-4">
                                    <div class="box">
                                        ...
                                        <div class="box-body">
                                            <div class="border rounded-sm shadow-sm p-6">
                                                <h3 class="h-4 bg-gray-200 rounded-sm" style="width: 40%;"></h3>

                                                <ul class="mt-5 space-y-3">
                                                <li class="w-full h-4 bg-gray-200 rounded-sm"></li>
                                                <li class="w-full h-4 bg-gray-200 rounded-sm"></li>
                                                <li class="w-full h-4 bg-gray-200 rounded-sm"></li>
                                                <li class="w-full h-4 bg-gray-200 rounded-sm"></li>
                                                </ul>
