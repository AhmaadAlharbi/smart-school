                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Products</h3>
                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-5">
                                ...
                                <div class="box">
                                    ...
                                    <span class="badge bg-gray-100 text-gray-800">
                                        Smart phone
                                        <button type="button" class="flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-500 focus:outline-none focus:bg-gray-200 focus:text-gray-500">
                                ...
                                <div class="box">
                                    ...
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-red-500 text-white hover:bg-red-600 focus:ring-red-500"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-yellow-500 text-white hover:bg-yellow-600 focus:ring-yellow-500"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-green-500 text-white hover:bg-green-600 focus:ring-green-500"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 ti-btn-primary"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-indigo-500 text-white hover:bg-indigo-600 focus:ring-indigo-500"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-purple-500 text-white hover:bg-purple-600 focus:ring-purple-500"></button>
                                    <button aria-label="button" type="button" class="ti-btn p-3 bg-pink-500 text-white hover:bg-pink-600 focus:ring-pink-500"></button>
                                    </div>
                                </div>
                                <div class="box">
                                    <div class="box-header">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <label for="category-1" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Electronics</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,937)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-2">
                                        <label for="category-2" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Mobiles</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,251)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-3">
                                        <label for="category-3" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Dress</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,9037)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-4">
                                        <label for="category-4" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Smart Phones</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(2,937)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-5">
                                        <label for="category-5" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Bags &amp; Purses</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,252)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-6">
                                        <label for="category-6" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Coat &amp; Jacket</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,251)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-7">
                                        <label for="category-7" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Beauty</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,563)</span>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-8">
                                        <label for="category-8" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Jeans</label>
                                        <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(1,284)</span>
                                        </div>
                                        <div id="category-collapse" class="hs-collapse hidden w-full transition-[height] duration-100" aria-labelledby="hs-category-collapse">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <label for="category-9" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Jewellery</label>
                                                <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(937)</span>
                                                </div>
                                                <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-10">
                                                <label for="category-10" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Sports</label>
                                                <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(22,255)</span>
                                                </div>
                                                <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-11">
                                                <label for="category-11" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Technology</label>
                                                <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(22,251)</span>
                                                </div>
                                                <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-12">
                                                <label for="category-12" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Watches</label>
                                                <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(22,564)</span>
                                                </div>
                                                <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="category-13">
                                                <label for="category-13" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Accessories</label>
                                                <span class="text-sm text-gray-500 ltr:ml-auto rtl:mr-auto">(22,255)</span>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                        <button type="button" class="hs-collapse-toggle w-full py-2 px-4 inline-flex justify-center items-center gap-2 rounded-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-0 focus:ring-primary focus:ring-offset-0 transition-all text-sm"
                                ...
                                <div class="box">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <label for="gender-1" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Female</label>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="gender-2">
                                        <label for="gender-2" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Male</label>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="gender-3">
                                        <label for="gender-3" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Kids</label>
                                        </div>
                                        <div class="flex">
                                        <input type="checkbox" class="ti-form-checkbox mt-0.5" id="gender-4">
                                        <label for="gender-4" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Others</label>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-body" id="brands">
                                        <div class="space-y-2">
                                            <div class="flex">
                                                ...
                                                <label for="brand-1" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Et EosInvidunt</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-2">
                                                <label for="brand-2" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Diam</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-3">
                                                <label for="brand-3" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Sit Dolor</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-4">
                                                <label for="brand-4" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Dolore Eos</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-5">
                                                <label for="brand-5" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Diam</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-6">
                                                <label for="brand-6" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Eos Labore</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-7">
                                                <label for="brand-7" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Duo Rebum</label>
                                            </div>
                                            <div class="flex">
                                                <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-8">
                                                <label for="brand-8" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Dolor</label>
                                            </div>
                                                ...
                                                <div class="mb-5">
                                                    <div class="space-y-2">
                                                        <div class="flex">
                                                            ...
                                                            <label for="brand-9" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Diam</label>
                                                        </div>
                                                        <div class="flex">
                                                            <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-10">
                                                            <label for="brand-10" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Dolor</label>
                                                        </div>
                                                        <div class="flex">
                                                            <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-11">
                                                            <label for="brand-11" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Duo
                                                                Rebum</label>
                                                        </div>
                                                        <div class="flex">
                                                            <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-12">
                                                            <label for="brand-12" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Eos
                                                                Labore</label>
                                                        </div>
                                                        <div class="flex">
                                                            <input type="checkbox" class="ti-form-checkbox mt-0.5" id="brand-13">
                                                            <label for="brand-13" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">Diam</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="button"
                                                class="hs-collapse-toggle w-full py-2 px-4 inline-flex justify-center items-center gap-2 rounded-sm border border-transparent font-semibold bg-primary text-white hover:bg-primary focus:outline-none focus:ring-0 focus:ring-primary focus:ring-offset-0 transition-all text-sm"
                                ...
                                <div class="grid grid-cols-12 gap-x-6">
                                    ...
                                    <div class="box product-box">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <a aria-label="anchor" href="{{url('wishlist')}}" class="z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i class="ri ri-heart-line"></i></a>
                                            <a aria-label="anchor" href="{{url('cart')}}" class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i class="ri ri-shopping-cart-2-line"></i></a>
                                            <a aria-label="anchor" href="{{url('products-details')}}" class="z-40 absolute top-[5.5rem] ltr:right-2 rtl:left-2 block bg-white p-2 leading-[0] rounded-full text-gray-500 text-base"><i class="ri ri-eye-line leading-none"></i></a>
                                            </div>
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4 (21,123 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$699</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$999</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.3 (23,123 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$245</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$599</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.5 (35,586 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$1999</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$1599</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">3.5 (15,253 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$399</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$499</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.2 (20,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$199</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$299</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.5 (22,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$399</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$599</span>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">3 (10,252 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$599</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$699</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">3.5 (10,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$299</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$399</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.5 (50,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$150</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$186</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">4.5 (45,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$100</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$150</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <p class=" my-auto text-gray-500  text-sm space-x-2 rtl:space-x-reverse">3.5 (45,989 views)</p>
                                            </div>
                                            <div class="flex space-x-2 rtl:space-x-reverse">
                                            <h5 class="text-lg font-semibold">$180</h5>
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$200</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-box box">
                                        ...
                                        <div class="product-details space-y-1">
                                            ...
                                            <span class="my-auto line-through  font-semibold text-base text-gray-500">$500</span>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
