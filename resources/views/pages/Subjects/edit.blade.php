                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="ti-form-select border border-gray-300 rounded-md p-2 w-full"
                                        ...
                                        <option selected value="{{$subject->specialization_id}}">
                                            {{$subject->department->Name}}</option>
                                        @foreach ($specializations as $specialization)
                                        @if($subject->specialization_id !== $specialization->id)
                                        ...
                                        <li class="ti-list-group bg-white text-gray-800">
                                            <div class="relative flex items-start w-full">
                                                <div class="flex items-center h-5">
                                                    <input id="hs-list-group-item-checkbox-{{ $grade->id }}"
                                                        name="grades[]" type="checkbox" class="ti-form-checkbox"
                                                        value="{{ $grade->id }}"
                                                        @if($subject->grades->contains($grade->id)) checked @endif>
                                                </div>
                                                <label for="hs-list-group-item-checkbox-{{ $grade->id }}"
