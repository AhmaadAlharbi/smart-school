                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Scrollspy</h3>
                                </div>
                                                    ...
                                                    <nav class="w-full mx-auto sm:flex sm:items-center sm:justify-between"
                                                        ...
                                                        <div id="navbar-collapse-basic"
                                                            ...
                                                            <div data-hs-scrollspy="#scrollspy-1" data-hs-scrollspy-offset="70"
                                                                ...
                                                                <a class="text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary"
                                                                    href="#first">First</a>
                                                                <a class="text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary"
                                                                    href="#second">Second</a>

                                                                <div data-hs-scrollspy-group class="hs-dropdown [--placement:bottom-right]">
                                                                    <a id="hs-mega-menu-basic-dr" class="group hs-scrollspy-active:text-primary mb-3 sm:mb-0 inline-flex justify-center items-center gap-2 text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary" href='javascript:;'>
                                                                        Dropdown
                                                                    ...
                                                                    <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] sm:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 sm:w-48 z-10 bg-white sm:shadow-md rounded-lg p-2 sm:dark:border before:absolute top-full sm:border before:-top-5 before:left-0 before:w-full before:h-5 hidden" style="">
                                                                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary" href="#third">
                                                                        Third
                                                                        </a>
                                                                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary" href="#fourth">
                                                                        Fourth
                                                                        </a>
                                                                        <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-700 leading-6 hover:text-gray-500 hs-scrollspy-active:text-primary" href="#fifth">
                                                                        Fifth
                                                                        </a>
                                                                    </div>
                                                                </div>
