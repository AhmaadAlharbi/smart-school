                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Nav &amp; Tabs</h3>
                                </div>
                                ...
                                <div class="col-span-12 xl:col-span-6">
                                    <div class="box">
                                        ...
                                        <nav class="sm:flex space-x-6 rtl:space-x-reverse">
                                            ...
                                            <a class="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none" href="javascript:void(0);">
                                            Disabled
                                            </a>
                                        </nav>
                                        </div>
                                ...
                                <div class="col-span-12 xl:col-span-6">
                                    <div class="box">
                                        ...
                                        <ul class="list-disc space-x-6 rtl:space-x-reverse">
                                            ...
                                            <li class="inline-block"><a class="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none" href="javascript:void(0);">
                                            Disabled
                                            </a></li>
                                        </ul>
                                        </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div id="hs-tab-js-behavior-1" role="tabpanel" aria-labelledby="hs-tab-js-behavior-item-1">
                                            <p class="text-gray-500 p-5 border ltr:rounded-tl-none rtl:rounded-tr-none rounded-sm border-gray-200">
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="flex">
                                        <div class="ltr:border-r rtl:border-l border-gray-200">
                                            <nav class="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true">
                                            <button type="button" class="hs-tab-active:bg-white ltr:hs-tab-active:border-r-transparent rtl:hs-tab-active:border-l-transparent hs-tab-active:text-primary ltr:dark:hs-tab-active:border-r-gray-800 rtl:dark:hs-tab-active:border-l-gray-800 -mr-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500  ltr:rounded-l-sm rtl:rounded-r-sm hover:text-gray-700 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                                                Tab 1
                                            </button>
                                        ...
                                        <div class="">
                                            ...
                                            <p class="text-gray-500 p-5 border ltr:border-l-0 rtl:border-r-0 rounded-sm ltr:rounded-tl-none rtl:rounded-tr-none border-gray-200">
                                                How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                                            </p>
                                            </div>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <select id="tab-select" class="mb-5 sm:hidden py-2 px-3 ltr:pr-9 rtl:pl-9 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary" aria-label="Tabs">
                                        ...
                                        <div class="hidden sm:block border-b-0 border-gray-200">
                                        <nav class="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs">
                                        ...
                                        <div id="hs-tab-to-select-1" role="tabpanel" aria-labelledby="hs-tab-to-select-item-1">
                                            <p class="text-gray-500 p-5 border rounded-sm  sm:ltr:rounded-tl-none sm:rtl:rounded-tr-none border-gray-200">
                                            How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                                            </p>
                                        </div>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="sm:border-b-2 border-gray-200">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <nav class="sm:flex sm:space-x-2" aria-label="Tabs">
                                            <button type="button" class="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary active" id="tabs-with-badges-item-1" data-hs-tab="#tabs-with-badges-1" aria-controls="tabs-with-badges-1">
                                            Tab 1 <span class="hs-tab-active:bg-primary hs-tab-active:text-white ml-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">99+</span>
                                            </button>
                                            <button type="button" class="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="tabs-with-badges-item-2" data-hs-tab="#tabs-with-badges-2" aria-controls="tabs-with-badges-2">
                                            Tab 2 <span class="hs-tab-active:bg-primary hs-tab-active:text-white ml-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">99+</span>
                                            </button>
                                            <button type="button" class="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="tabs-with-badges-item-3" data-hs-tab="#tabs-with-badges-3" aria-controls="tabs-with-badges-3">
                                            Tab 3
                                            </button>
                                        </nav>
                                        </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <nav class="flex space-x-2 rtl:space-x-reverse">
                                            <a class="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700 active" href="javascript:void(0);" id="card-type-item-1" data-hs-tab="#card-type-1" aria-controls="card-type-1">
                                            Active
                                            </a>
                                            <a class="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700" href="javascript:void(0);" id="card-type-item-2" data-hs-tab="#card-type-2" aria-controls="card-type-2">
                                            Tab 1
                                            </a>
                                            <a class="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700" href="javascript:void(0);" id="card-type-item-3" data-hs-tab="#card-type-3" aria-controls="card-type-3">
                                            Tab 2
                                            </a>
                                        </nav>
                                        </div>
                                        ...
                                        <div id="card-type-1" role="tabpanel" aria-labelledby="card-type-item-1">
                                            <p class="text-gray-500 p-5 border rounded-sm ltr:rounded-tl-none rtl:rounded-tr-none border-gray-200">
                                            How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                                            </p>
                                        </div>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <div class="sm:flex bg-gray-100 hover:bg-gray-200 rounded-sm transition p-1">
                                            <nav class="sm:flex sm:space-x-2 rtl:space-x-reverse">
                                            <a class="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary active" href="javascript:void(0);"  id="segment-item-1" data-hs-tab="#segment-1" aria-controls="segment-1">
                                                Active
                                            </a>
                                            ...
                                            <a class="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 font-medium rounded-sm pointer-events-none" href="javascript:void(0);" id="segment-item-4" data-hs-tab="#segment-4">
                                                Disabled
                                            </a>
                                            </nav>
                                        </div>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <nav class="relative z-0 sm:flex border rounded-sm divide-y sm:divide-y-0 sm:divide-x rtl:divide-x-reverse divide-gray-200 overflow-hidden">
                                        <a class="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 group relative min-w-0 flex-1 bg-white py-4 px-4 text-gray-500 hover:text-gray-700 text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:z-10 active" href="javascript:void(0);" id="bar-item-1" data-hs-tab="#bar-1" aria-controls="bar-1">
                                            Active
                                        </a>

                                        <a class="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 group relative min-w-0 flex-1 bg-white py-4 px-4 text-gray-500 hover:text-gray-700 text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:z-10" href="javascript:void(0);" id="bar-item-2" data-hs-tab="#bar-2" aria-controls="bar-2">
                                            Link
                                        </a>
                                        ...
                                        <a class="justify-center items-center sm:flex inline-flex w-full sm:w-auto hs-tab-active:border-b-2 hs-tab-active:!border-b-primary hs-tab-active:text-gray-900 group relative min-w-0 flex-1 bg-white py-4 px-4 text-gray-400 text-sm font-medium text-center pointer-events-none overflow-hidden focus:z-10" href="javascript:void(0);" id="bar-item-4" data-hs-tab="#bar-4">
                                            Disabled
                                        </a>
                                        </nav>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <button type="button" class="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary active" id="pills-on-gray-color-item-1" data-hs-tab="#pills-on-gray-color-1" aria-controls="pills-on-gray-color-1">
                                            Tab 1
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary" id="pills-on-gray-color-item-2" data-hs-tab="#pills-on-gray-color-2" aria-controls="pills-on-gray-color-2">
                                            Tab 2
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-gray-200 hs-tab-active:text-gray-800 hs-tab-active:hover:text-gray-800 py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary" id="pills-on-gray-color-item-3" data-hs-tab="#pills-on-gray-color-3" aria-controls="pills-on-gray-color-3">
                                            Tab 3
                                        </button>
                                        </nav>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <nav class="flex space-x-2" aria-label="Tabs">
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary  active" id="pills-with-brand-color-item-1" data-hs-tab="#pills-with-brand-color-1" aria-controls="pills-with-brand-color-1">
                                            Tab 1
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary " id="pills-with-brand-color-item-2" data-hs-tab="#pills-with-brand-color-2" aria-controls="pills-with-brand-color-2">
                                            Tab 2
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white py-3 px-4 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary " id="pills-with-brand-color-item-3" data-hs-tab="#pills-with-brand-color-3" aria-controls="pills-with-brand-color-3">
                                            Tab 3
                                        </button>
                                        </nav>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <nav class="flex space-x-2" aria-label="Tabs">
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary active" id="fill-and-justify-item-1" data-hs-tab="#fill-and-justify-1" aria-controls="fill-and-justify-1">
                                            Tab 1
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary" id="fill-and-justify-item-2" data-hs-tab="#fill-and-justify-2" aria-controls="fill-and-justify-2">
                                            This is the longest link I've seen
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white flex-auto py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary" id="fill-and-justify-item-3" data-hs-tab="#fill-and-justify-3" aria-controls="fill-and-justify-3">
                                            Tab 3
                                        </button>
                                        </nav>
                            ...
                            <div class="col-span-12 md:col-span-6 xxl:!col-span-4">
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <nav class="flex space-x-2" aria-label="Tabs">
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary active" id="equal-width-elements-item-1" data-hs-tab="#equal-width-elements-1" aria-controls="equal-width-elements-1">
                                            Tab 1
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary" id="equal-width-elements-item-2" data-hs-tab="#equal-width-elements-2" aria-controls="equal-width-elements-2">
                                            This is the longest link I've seen
                                        </button>
                                        <button type="button" class="hs-tab-active:bg-primary hs-tab-active:text-white basis-0 grow py-3 px-4 inline-flex justify-center items-center gap-2 bg-transparent text-center text-sm font-medium text-gray-500 rounded-sm hover:text-primary" id="equal-width-elements-item-3" data-hs-tab="#equal-width-elements-3" aria-controls="equal-width-elements-3">
                                            Tab 3
                                        </button>
                                        </nav>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <nav class="-mb-0.5 flex justify-center space-x-6 rtl:space-x-reverse" aria-label="Tabs">
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary active" id="horizontal-alignment-item-1" data-hs-tab="#horizontal-alignment-1" aria-controls="horizontal-alignment-1">
                                            Tab 1
                                            </button>
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="horizontal-alignment-item-2" data-hs-tab="#horizontal-alignment-2" aria-controls="horizontal-alignment-2">
                                            Tab 2
                                            </button>
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="horizontal-alignment-item-3" data-hs-tab="#horizontal-alignment-3" aria-controls="horizontal-alignment-3">
                                            Tab 3
                                            </button>
                                        </nav>
                                        </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <nav class="-mb-0.5 flex justify-end space-x-6 rtl:space-x-reverse" aria-label="Tabs">
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary active" id="horizontal-right-alignment-item-1" data-hs-tab="#horizontal-right-alignment-1" aria-controls="horizontal-right-alignment-1">
                                            Tab 1
                                            </button>
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="horizontal-right-alignment-item-2" data-hs-tab="#horizontal-right-alignment-2" aria-controls="horizontal-right-alignment-2">
                                            Tab 2
                                            </button>
                                            <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary" id="horizontal-right-alignment-item-3" data-hs-tab="#horizontal-right-alignment-3" aria-controls="horizontal-right-alignment-3">
                                            Tab 3
                                            </button>
                                        </nav>
                                        </div>
