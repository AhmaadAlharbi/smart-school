                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Invoice Details</h3>
                                </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="py-5">
                                            <div class="overflow-auto">
                                                <table class="ti-custom-table !border">
                                                <thead class="bg-gray-100 overflow-hidden">
                                                    <tr>
                                                ...
                                                <tbody class="">
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <p class="text-gray-500">PhotoShop</p>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            <p class="text-gray-500">Android Studio</p>
                                                        </td>
                                                    ...
                                                    <tr class="!border-b-0">
                                                        <td colspan="3" class="ltr:border-r rtl:border-l border-gray-200">
                                                    ...
                                                    <tr class="!border-b-0 !border-t-0">
                                                        <td colspan="3" class="ltr:border-r rtl:border-l border-gray-200">Account :<span class="font-bold"> 000252522525253625</span> </td>
                                                        <td class="">Tax</td>
                                                        <td class="!text-end">3%</td>
                                                    </tr>
                                                    <tr class="!border-b-0 !border-t-0">
                                                        <td colspan="3" class="ltr:border-r rtl:border-l border-gray-200">Account Name : <span class="font-bold"> Synto</span></td>
                                                        <td class="">Discount</td>
                                                        <td class="!text-end">20%</td>
                                                    </tr>
                                                    <tr  class="!border-t-0">
                                                        <td colspan="3" class="ltr:border-r rtl:border-l border-gray-200">Bank Details :<span class="font-bold"> Lorem Ipsum</span> </td>
                                                        <td class="">Total</td>
                                        ...
                                        <div class="sm:grid grid-cols-12 gap-6 pb-5 space-y-5">
                                            <div class="lg:col-span-6 col-span-12">
                                                ...
                                                <p class="text-gray-500 font-light text-sm">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                            </div>
