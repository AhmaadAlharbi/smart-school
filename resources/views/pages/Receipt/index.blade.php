                            ...
                            <table class="ti-custom-table ti-custom-table-head">
                                ...
                                <tbody>
                                    @foreach ($receipt_students as $receipt_student)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('receipt_students.edit', $receipt_student->id) }}"
                                                    ...
                                                    {{ trans('My_Classes_trans.Edit') }}</a>

                                                <button type="button"
                                                    data-target="#Delete_receipt{{ $receipt_student->id }}"
                                                    data-hs-overlay="#Delete_receipt{{ $receipt_student->id }}"
                                        ...
                                        {{-- delete modal --}}
                                        <div id="Delete_receipt{{ $receipt_student->id }}"
                                            ...
                                            <div class="ti-modal-box">
                                                <div class="ti-modal-content">
                                                    ...
                                                    <div class="ti-modal-body">
                                                        ...
                                                        <form
                                                            action="{{ route('receipt_students.destroy', $receipt_student->id) }}"
                                                            method="post">
                                                            @method('DELETE')
                                                            @csrf
                                                            {{ trans('Grades_trans.Warning_Grade') }}
                                                            <input id="id" type="hidden" name="id"
                                                                class="form-control" value="{{ $receipt_student->id }}">
