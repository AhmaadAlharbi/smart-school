                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Team Members</h3>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-span-12 xl:col-span-4">
                                        ...
                                        <nav class="flex justify-center space-x-3 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                                            <button type="button"
                                            class="w-full hs-tab-active:!bg-primary hs-tab-active:!text-white -mr-px p-2 items-center bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-sm hover:text-gray-700 active"
                                            id="tab-1" data-hs-tab="#tab-style-1" aria-controls="tab-style-1" role="tab">
                                            All Team Members
                                            </button>
                                            <button type="button"
                                            class="w-full hs-tab-active:!bg-primary hs-tab-active:!text-white ltr:-ml-px rtl:-mr-px p-2 items-center bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-sm hover:text-gray-700"
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                <div class="col-span-12">
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <a class="relative inline-block mt-8" href="{{url('profile')}}">
                                                    ...
                                                    class="w-24 h-24 rounded-full ring-4 ring-gray-100 mx-auto" alt="user-img">
                                                    <span
                                                    class="absolute bottom-0 ltr:right-0 rtl:left-0 block p-1 rounded-full ring-2 ring-white text-gray-500 bg-gray-100 leading-none"><i
                                                        class="ri ri-pencil-line"></i></span>
                                                </a>
                                                <div class="space-y-2">
                                                    <div class="mt-4">
                                                    <h2 class="text-base font-semibold">Socrates Itumay</h2>
                                                    <p class="text-xs text-gray-500">socratesItumay@abc.com</p>
                                                    </div>
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <button type="button" class="hs-tooltip-toggle m-0 rounded-full p-2 ti-btn ti-btn-outline  border-gray-200 text-gray-500 ring-transparent">
                                                ...
                                                <div
                                                    class="hs-dropdown ti-dropdown absolute top-0 ltr:right-0 rtl:left-0 block text-gray-100 text-base">
                                            ...
                                            <div class="box-footer bg-gray-100 p-0 text-center">
                                                <div class="grid grid-cols-12 gap-6">
                                                <div class="col-span-6 ltr:border-r rtl:border-l p-3 border-gray-200">
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">eostempor@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">airisatou@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">etkasd@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">andersonitumay@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500"> samanthapaul@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">mcgreggor@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">emileyjackson@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">nicholassams@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">popejohnson@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">meganfox@abc.com</p>
                                                    </div>
                                        ...
                                        <div class="col-span-12 md:col-span-6 xxl:col-span-3 team-box">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p class="text-xs text-gray-500">dolordlita@abc.com</p>
                                                    </div>
                                    ...
                                    <a class="w-10 h-10 text-gray-500 bg-gray-200 hover:text-primary p-4 inline-flex items-center gap-2 rounded-full" href="javascript:void(0);">
                                    ...
                                    <a class="w-10 h-10  bg-gray-200 text-gray-500 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="javascript:void(0);">2</a>
                                    <a class="w-10 h-10  bg-gray-200 text-gray-500 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="javascript:void(0);">3</a>
                                    <a class="w-10 h-10 text-gray-500 bg-gray-200 hover:text-primary p-4 inline-flex items-center gap-2 rounded-full" href="javascript:void(0);">
