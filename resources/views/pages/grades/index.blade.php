                ...
                <div class="ti-modal-body">
                    <div class="box-body">
                        <form action="{{ route('grades.store') }}" method="POST">
                            @csrf
                            <div class="max-w-sm ">
                                <label for="">{{ trans('Grades_trans.stage_name_ar') }} <span class="text-red-500 font-bold">*</span></label>
                                <input type="text" class="ti-form-input  my-2 " name="Name" value="{{ old('Name') }}">
                                @if ($errors->has('Name'))
                                    <span class="text-red-500 block">{{ $errors->first('Name') }}</span>
                                @endif
                                <label for="">{{ trans('Grades_trans.stage_name_en') }} <span class="text-red-500 font-bold">*</span></label>
