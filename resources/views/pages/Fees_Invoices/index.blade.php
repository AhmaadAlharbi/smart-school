                    ...
                    <div class="box-body">
                        <table class="ti-custom-table ti-custom-table-head ti-custom-table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('Fees_Invoices.edit',$Fee_invoice->id)}}"
                                            class="ti-btn ti-btn-soft-success"> {{trans('Grades_trans.Edit')}}</a>

                                        <button type="button" data-target="#delete{{ $Fee_invoice->id }}"
                                            data-hs-overlay="#Delete_Fee_invoice{{$Fee_invoice->id}}"
                                ...
                                {{--delete modal --}}
                                <div id="Delete_Fee_invoice{{$Fee_invoice->id}}" class="hs-overlay ti-modal hidden">
                                    <div class="ti-modal-box">
                                        <div class="ti-modal-content">
                                            ...
                                            <div class="ti-modal-body">
                                                ...
                                                <form action="{{ route('Fees_Invoices.destroy', $Fee_invoice->id) }}"
                                                    method="post">
                                                    @method('DELETE')
                                                    @csrf
