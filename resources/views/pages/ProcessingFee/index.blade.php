                    ...
                    <div class="box-body">
                        <table class="ti-custom-table ti-custom-table-head ti-custom-table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('ProcessingFee.edit',$ProcessingFee->id)}}"
                                            ...
                                            {{trans('Grades_trans.Edit')}}</a>
                                        <button type="button" data-target="#Delete_receipt{{ $ProcessingFee->id }}"
                                            data-hs-overlay="#Delete_receipt{{ $ProcessingFee->id }}"
                                ...
                                {{--delete modal --}}
                                <div id="Delete_receipt{{ $ProcessingFee->id }}" class="hs-overlay ti-modal hidden">
                                    <div class="ti-modal-box">
                                        <div class="ti-modal-content">
                                            ...
                                            <div class="ti-modal-body">
                                                ...
                                                <form action="{{ route('ProcessingFee.destroy', $ProcessingFee->id) }}"
                                                    method="post">
                                                    @method('DELETE')
                                                    @csrf
