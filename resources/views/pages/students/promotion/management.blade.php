                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="ti-btn rounded-full ti-btn-ghost-danger"
                                                        data-hs-overlay="#delete{{ $promotion->id }}"
                                                    ...
                                                    <button type="button" class="btn text-green-500" data-toggle="modal"
                                                        data-target="#">تخرج الطالب</button>
                                                </td>
                                            </tr>

                                            {{-- delete model --}}
                                            <div id="delete{{ $promotion->id }}" class="hs-overlay ti-modal hidden">
                                                <div class="ti-modal-box">
                                                    <div class="ti-modal-content">
                                                        ...
                                                        <div class="ti-modal-body">
                                                            ...
                                                            <form action="{{ route('promotion.destroy', $promotion->id) }}"
                                                                method="post">
                                                                @method('DELETE')
                                                                @csrf
