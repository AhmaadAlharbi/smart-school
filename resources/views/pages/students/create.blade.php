...
{{--                                </div>--}}
                                <div class="grid lg:grid-cols-5 gap-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <select class="ti-form-select" name="Classroom_id" onchange="fetchSections(this.value)">
                                ...
                                <button class="ti-btn ti-btn-primary mt-4" type="submit">{{trans('Students_trans.submit')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
