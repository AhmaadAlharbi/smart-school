                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Progress</h3>
                                </div>
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="box">
                                        ...
                                        <div class="box-body space-y-4">
                                            <div class="ti-main-progress  h-4 bg-gray-200">
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="box">
                                        ...
                                        <div class="box-body space-y-4">
                                            <div class="ti-main-progress  h-1 bg-gray-200">
                                            ...
                                            <div class="ti-main-progress  h-6 bg-gray-200">
                                            ...
                                            <div class="ti-main-progress  h-8 bg-gray-200">
                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="box">
                                        ...
                                        <div class="box-body space-y-4">
                                            <div class="ti-main-progress h-1 bg-gray-200 rounded-full overflow-hidden">
                                            ...
                                            <div class="ti-main-progress h-2 bg-gray-200 rounded-full overflow-hidden">
                                            ...
                                            <div class="ti-main-progress h-3 bg-gray-200 rounded-full overflow-hidden">
                                            ...
                                            <div class="ti-main-progress h-4 bg-gray-200 rounded-full overflow-hidden">
                                            ...
                                            <div class="ti-main-progress h-6 bg-gray-200 rounded-full overflow-hidden">
                                            ...
                                            <div class="ti-main-progress h-8 bg-gray-200 rounded-full overflow-hidden">
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="box-body">
                                            <div class="flex space-x-8 rtl:space-x-reverse">
                                                <div class="ti-main-progress flex-col flex-nowrap justify-end w-2 h-40 bg-gray-200">
                                                ...
                                                <div class="ti-main-progress flex-col flex-nowrap justify-end w-3 h-40 bg-gray-200">
                                                ...
                                                <div class="ti-main-progress flex-col flex-nowrap justify-end w-4 h-40 bg-gray-200">
                                                ...
                                                <div class="ti-main-progress flex-col flex-nowrap justify-end w-5 h-40 bg-gray-200">
                                                ...
                                                <div class="ti-main-progress flex-col flex-nowrap justify-end w-6 h-40 bg-gray-200">
