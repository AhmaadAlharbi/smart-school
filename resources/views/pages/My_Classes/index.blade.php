                                            ...
                                            <tr>
                                                <th scope="col" class="py-2 ltr:pr-0 rtl:pl-0">
                                                    <div class="flex items-center h-5">
                                                        ...
                                                        <label for="hs-table-search-checkbox-all1"
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end font-medium">
                                                    ...
                                                    <button type="button" data-target="#delete{{ $My_Class->id }}"
                                                ...
                                                {{-- edit modal --}}
                                                <div id="edit{{ $My_Class->id }}" class="hs-overlay ti-modal hidden">
                                                            ...
                                                            <div class="ti-modal-body">
                                                                <form
                                                                    ...
                                                                    <div class="max-w-sm ">
                                                                        ...
                                                                        <input type="text" class="ti-form-input  my-2 "
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <select name="Grade_id"
                                                                                ...
                                                                                <option
                                                                                    value="{{$My_Class->Grades->id}}">
                                                                                    {{$My_Class->Grades->Name}}</option>
                                                ...
                                                {{--delete model--}}
                                                <div id="delete{{ $My_Class->id }}" class="hs-overlay ti-modal hidden">
                                                    <div class="ti-modal-box">
                                                        <div class="ti-modal-content">
                                                            <div class="ti-modal-header">
                                                                <h3 class="ti-modal-title">
                    ...
                    <div class="ti-modal-body">
                        <form action="{{ route('classrooms.store') }}" method="post">
                            ...
                            <div class="flex justify-evenly items-center ">
                                ...
                                <div>
                                    <label for="Name">{{
                                        trans('My_Classes_trans.Name_class') }} <span
                                ...
                                <div>
                                    <label for="Name" class="mr-sm-2">{{
                                        trans('My_Classes_trans.Name_class_en') }} <span
                                            class="text-red-500 font-bold">*</span></label>
                                ...
                                {{-- opeartions--}}
                                <div>
                                    <button type="button" class="ti-btn ti-btn-danger" onclick="deleteForm(0)">
                            ...
                            <div id="form-footer" class="ti-modal-footer">
                                <button id="add-form-btn" type="button" class="ti-btn ti-btn-dark" onclick="addForm()">
