                        ...
                        <div class="main-content">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                ...
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        <img class="rounded-sm avatar avatar-xs" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <img class="rounded-sm avatar avatar-sm" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <img class="rounded-sm avatar" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <img class="rounded-sm avatar avatar-lg" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                    </div>
                                    </div>
                                </div>
                                <div class="col-span-12 xl:col-span-4">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                ...
                                <div class="col-span-12 xl:col-span-4">
                                    ...
                                    <div class="box-body space-x-2 rtl:space-x-reverse sm:space-x-6 space-y-2 last:xl:space-x-0">
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-xs" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <span
                                        ...
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-sm" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <span
                                        ...
                                        <div class="relative inline-block">
                                        <img class="avatar rounded-sm avatar-lg" src="{{asset('build/assets/img/users/1.jpg')}}" alt="Image Description">
                                        <span
