                ...
                <div class="content">
                    ...
                    <div class="main-content">
                        ...
                        <div class="block justify-between page-header sm:flex">
                            <div>
                                <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Breadcrumb</h3>
                            </div>
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="box-body">
                                ...
                                <li class="text-sm">
                                    <a class="flex items-center text-primary hover:text-primary" href="javascript:void(0);">
                                    <svg class="flex-shrink-0 ltr:mr-3 rtl:ml-3 h-4 w-4 text-primary hover:text-primary" width="16" height="16"
