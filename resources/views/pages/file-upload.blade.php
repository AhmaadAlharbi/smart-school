                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> File Uploads</h3>
                                </div>
                                        ...
                                        <div class="box-body">
                                            <div>
                                                <label class="block">
                                                    ...
                                                    <input type="file" class="block w-full text-sm text-gray-500 focus:outline-0
