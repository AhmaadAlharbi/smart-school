                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Wishlist</h3>
                                </div>
                                ...
                                <div class="box product-box">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a aria-label="anchor" href="{{url('cart')}}"
                                            class="z-40 absolute top-12 ltr:right-2 rtl:left-2 block bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i
                                            class="ri ri-shopping-cart-2-line"></i></a>
                                        <a aria-label="anchor" href="javascript:void(0);" class="wishlist z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i
                                ...
                                <div class="product-box box">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a aria-label="anchor" href="javascript:void(0);"
                                            class="wishlist z-40 absolute top-2 ltr:right-2 rtl:left-2 block bg-white p-2 leading-none rounded-full text-gray-500 text-base"><i
                                            class="ri ri-delete-bin-line"></i></a>
                                            <a aria-label="anchor" href="{{url('products-details')}}" class="z-40 absolute top-[5.5rem] ltr:right-2 rtl:left-2 block bg-white p-2 leading-[0] rounded-full text-gray-500 text-base"><i class="ri ri-eye-line leading-none"></i></a>
                                        </div>
                                        <a href="{{url('products-details')}}"
