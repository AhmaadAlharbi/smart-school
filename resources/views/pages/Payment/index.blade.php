                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('Payment_students.edit', $payment_student->id) }}"
                                                    class="ti-btn rounded-full ti-btn-ghost-success" role="button"
                                                    aria-pressed="true"> {{ trans('Grades_trans.Edit') }}</a>
                                                <button type="button"
                                                    data-target="#Delete_receipt{{ $payment_student->id }}"
                                                    data-hs-overlay="#Delete_receipt{{ $payment_student->id }}"
                                                    class="ti-btn rounded-full ti-btn-ghost-danger">
                                                    {{ trans('Grades_trans.Delete') }}
                                            </td>
                                        </tr>
                                        {{-- delete modal --}}
                                        <div id="Delete_receipt{{ $payment_student->id }}"
                                                    ...
                                                    <div class="ti-modal-body">
                                                        ...
                                                        <form
                                                            ...
                                                            <input id="id" type="hidden" name="id"
                                                                class="form-control" value="{{ $payment_student->id }}">
