                ...
                <div class="box">
                    <div class="box-body">
                        <div class="overflow-auto">
                            <a href="{{route('fees.create')}}" class="ti-btn ti-btn-primary my-3" role="button"
                            ...
                            <table class="ti-custom-table ti-custom-table-head ti-custom-table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('fees.edit',$fee->id)}}"
                                                class="ti-btn ti-btn-soft-success">Edit</a>
                                            <button type="button" data-target="#delete{{ $fee->id }}"
                                                data-hs-overlay="#delete{{ $fee->id }}"
                                    ...
                                    {{--delete model--}}
                                    <div id="delete{{ $fee->id }}" class="hs-overlay ti-modal hidden">
