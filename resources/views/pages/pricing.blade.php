                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Pricing Tables</h3>
                                </div>
                                ...
                                <div class="box-body py-14">
                                    <div class="sm:grid grid-cols-12 sm:space-y-0 space-y-6 gap-6 max-w-6xl mx-auto">
                                        <div class="lg:col-span-4 col-span-12">
                                            <div class="p-6 shadow border text-center rounded-sm ">
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800">Basic</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$10</span>
                                        ...
                                        <div class="lg:col-span-4 col-span-12">
                                            <div class="p-6 shadow border text-center rounded-sm ">
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800">Premium</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$50</span>
                                                    <span class="text-gray-500 font-medium"> / Month</span>
                                                </div>
                                                <ul class="p-0 my-4 space-y-3">
                                                    <li class="flex space-x-4 rtl:space-x-reverse">
                                        ...
                                        <div class="lg:col-span-4 col-span-12">
                                            <div class="p-6 shadow border text-center rounded-sm ">
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800">Standard</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$25</span>
                                                    <span class="text-gray-500 font-medium"> / Month</span>
                                                </div>
                                                <ul class="p-0 my-4 space-y-3">
                                                    <li class="flex space-x-4 rtl:space-x-reverse">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body py-14">
                                    <div class="sm:grid grid-cols-12 sm:space-y-0 space-y-6 lg:gap-0 gap-6 max-w-6xl mx-auto">
                                        <div class="lg:col-span-4 col-span-12">
                                            <div class="relative p-6 shadow border text-center rounded-sm ">
                                                <div class="absolute top-0 inset-x-0 h-0.5 bg-warning" aria-hidden="true"></div>
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800 text-warning">Basic</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$10</span>
                                                    <span class="text-gray-500 font-medium"> / Month</span>
                                        ...
                                        <div class="lg:col-span-4 col-span-12 lg:scale-110 z-10 bg-white shadow-lg">
                                            <div class="relative p-6 shadow border text-center rounded-sm ">
                                                <div class="absolute top-0 inset-x-0 h-0.5 bg-primary" aria-hidden="true"></div>
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800 text-primary">Premium</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$50</span>
                                                    <span class="text-gray-500 font-medium"> / Month</span>
                                        ...
                                        <div class="lg:col-span-4 col-span-12">
                                            <div class="relative p-6 shadow border text-center rounded-sm ">
                                                ...
                                                <h3 class="mb-4 text-2xl font-semibold text-gray-800 text-danger">Standard</h3>
                                                <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                <div class="flex justify-center my-7 items-baseline">
                                                    <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$25</span>
                                                    <span class="text-gray-500 font-medium"> / Month</span>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-500">We have several plans to showcase your business.</p>
                                        <div class="mt-5 text-center">
                                            <nav class="flex justify-center bg-gray-100 p-2 mx-auto w-fit rounded-full gap-2" aria-label="Tabs" role="tablist">
                                                <button type="button" class="hs-tab-active:!bg-primary hs-tab-active:!text-white -mb-px py-2 px-4 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-full hover:text-gray-700 active" id="pricing-1" data-hs-tab="#pricing-style-1" aria-controls="pricing-style-1" role="tab">
                                                Monthly
                                                </button>
                                                <button type="button" class="hs-tab-active:!bg-primary hs-tab-active:!text-white -mb-px py-2 px-4 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-full hover:text-gray-700" id="pricing-2" data-hs-tab="#pricing-style-2" aria-controls="pricing-style-2" role="tab">
                                                Yearly
                                                </button>
                                            </nav>
                                            </div>
                                                ...
                                                <div class="sm:grid grid-cols-12 sm:space-y-0 space-y-6 max-w-6xl mx-auto">
                                                    <div class="lg:col-span-4 col-span-12">
                                                        <div class="relative p-6 shadow border text-center rounded-sm ">
                                                            ...
                                                            <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                            <div class="flex justify-center my-7 items-baseline">
                                                                <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$180</span>
                                                                <span class="text-gray-500 font-medium"> / Yearly</span>
                                                            </div>
                                                            <ul class="p-0 my-4 space-y-3">
                                                                <li class="flex space-x-4 rtl:space-x-reverse">
                                                                    <span><i class="ri ri-check-line text-success text-xl"></i></span>
                                                    ...
                                                    <div class="lg:col-span-4 col-span-12 lg:scale-110 z-10 bg-white shadow-lg">
                                                        <div class="relative p-6 shadow border text-center rounded-sm ">
                                                            ...
                                                            <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                            <div class="flex justify-center my-7 items-baseline">
                                                                <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$350</span>
                                                                <span class="text-gray-500 font-medium"> / Yearly</span>
                                                            </div>
                                                            <ul class="p-0 my-4 space-y-3">
                                                                <li class="flex space-x-4 rtl:space-x-reverse">
                                                    ...
                                                    <div class="lg:col-span-4 col-span-12">
                                                        <div class="relative p-6 shadow border text-center rounded-sm ">
                                                            ...
                                                            <p class="text-gray-500">Sed duo rebum et et dolores sed amet rebum magna. Et sea elitr.</p>
                                                            <div class="flex justify-center my-7 items-baseline">
                                                                <span class="ltr:mr-2 rtl:ml-2 text-5xl font-bold text-gray-800">$225</span>
                                                                <span class="text-gray-500 font-medium"> / Yearly</span>
                                                            </div>
                                                            <ul class="p-0 my-4 space-y-3">
                                                                <li class="flex space-x-4 rtl:space-x-reverse">
