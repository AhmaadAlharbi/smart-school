                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Blog Details</h3>
                                </div>
                            ...
                            <div class="col-span-12 xxl:col-span-9">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="md:flex justify-between mb-5 space-y-2 md:space-y-0">
                                        ...
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <p class="flex space-x-2 rtl:space-x-reverse text-slate-700 text-sm font-medium"><i class="ri ri-calendar-line text-sm"></i><span>29 September,2022</span></p>
                                        </div>
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                            <p class="flex space-x-2 rtl:space-x-reverse text-slate-700 text-sm font-medium"><span class="w-1.5 h-1.5 inline-block bg-primary rounded-full my-auto"></span><span>Lifestyle</span></p>
                                        </div>
                                        </div>
                                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                        <p class="flex space-x-2 rtl:space-x-reverse text-slate-700 text-sm font-medium"><i class="ri ri-chat-3-line text-sm"></i><span>(20) Comments</span></p>
                                        </div>
                                    </div>
                                    <h5 class="font-semibold text-slate-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Elitr vero et at eirmod labore et clita invidunt lorem.</h5>
                                    <p class="mt-3 mb-3 text-gray-500 text-sm">I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. No one rejects, dislikes, or avoids pleasure itself, because it is pleasure.</p>
                                    <div class="box bg-gray-100 mb-5 shadow-none">
                                        ...
                                        <blockquote class="relative text-center max-w-2xl mx-auto">
                                            ...
                                            <p class="text-xl text-gray-800">
                                                <em class="relative">
                                                <span class="relative z-10">In nature, nothing is perfect and everything is perfect. Trees can be contorted, bent in weird ways, and they're still beautiful..</span>
                                                </em>
                                    ...
                                    <p class="mt-3 mb-3 text-gray-500 text-sm">but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example.</p>
                                    <div>
                                ...
                                <div class="box-footer bg-transparent">
                                    ...
                                    <div class="sm:flex items-center sm:space-x-3 space-y-2 sm:space-y-0 rtl:space-x-reverse">
                                        <a href="javascript:void(0);" class="text-xs text-gray-500 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i class="text-xs ri ri-heart-line"></i><span>30 Likes</span></a>
                                        <a href="javascript:void(0);" class="text-xs text-gray-500 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i class="text-xs ri ri-share-line"></i><span>350 Shares</span></a>
                                    </div>
                                    <div class="space-x-2">
                                        <a href="javascript:void(0);" class="text-xs text-gray-500 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i class="text-xs ri ri-eye-line"></i><span>30k Views</span></a>
                                    </div>
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <label for="hs-default-checkbox" class="text-sm text-gray-500 ltr:ml-3 rtl:mr-3">I Am Not A Robot</label>
                                    </div>
                            ...
                            <div class="col-span-12 xxl:col-span-3">
                                ...
                                <div class="box-body">
                                    ...
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        ...
                                        <p class="flex space-x-2 rtl:space-x-reverse text-gray-500 text-xs"><i class="ri ri-calendar-line text-xs"></i><span>Sept 29 , 2022</span></p>
                                        </div>
                                    </a>
                                    </li>
                                    ...
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        ...
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                        <p class="flex space-x-2 rtl:space-x-reverse text-gray-500 text-xs"><i class="ri ri-time-line text-xs"></i><span>3 hours ago</span></p>
                                        </div>
                                    </a>
                                    </li>
                                    <li class="ti-list-group px-0 border-0 text-gray-800">
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        ...
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                        <p class="flex space-x-2 rtl:space-x-reverse text-gray-500 text-xs"><i class="ri ri-time-line text-xs"></i><span>30 mins ago</span></p>
                                        </div>
                                    </a>
                                    </li>
                                    <li class="ti-list-group px-0 border-0 text-gray-800">
                                    <a href="javascript:void(0);" class="space-x-3 flex rtl:space-x-reverse">
                                        ...
                                        <div class="space-y-1 my-auto">
                                        <h3 class="font-semibold text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                                        <p class="flex space-x-2 rtl:space-x-reverse text-gray-500 text-xs"><i class="ri ri-calendar-line text-xs"></i><span>l day ago</span></p>
                                        </div>
                                    </a>
                                    </li>
                                    <li class="ti-list-group px-0 border-0 text-gray-800">
