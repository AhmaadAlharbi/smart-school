                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Timeline</h3>
                                </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="flex w-full pb-8">
                                        ...
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500"><span class="text-dark">Elida
                                    ...
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500"><span class="text-dark">Samantha
                                    ...
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500"><span class="text-dark">Dennis
                                        ...
                                        <div class="space-y-3">
                                            <p class="text-xs text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    ...
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500"><span class="text-dark">Anesthesia</span>
                                    ...
                                    <div class="mx-auto relative">
                                        ...
                                        <div
                                        class="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px] leading-[2.3] text-gray-800">
                                        H
                                        </div>
                                    </div>
                                    <div class="flex w-full pb-8">
                                        <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500"><span class="text-dark">Harvey
                                    ...
                                    <div class="flex w-full">
                                        ...
                                        <div class="border border-gray-200 bg-gray-50 p-4 rounded-sm">
                                            <p class="text-xs text-gray-500 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum sit consequuntur quia aperiam quibusdam rerum ut! </p>
                                            <p class="text-xs text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit.veniam odit totam rem asperiores adipisci, sed quia voluptas?</p>
                                        </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-left">
                                            ...
                                            <div class="box">
                                                ...
                                                <p class="text-xs text-gray-500">Nonumy erat nonumy dolores duo ea sit, ipsum sed amet aliquyam magna kasd at. Dolor erat sit sed sea et dolor, justo dolor ipsum dolore voluptua. Sed ipsum sed.</p>
                                                </div>
                                                ...
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="text-xs leading-[0] text-gray-500 space-x-2 rtl:space-x-reverse rounded-full bg-gray-100 px-3 py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 inline-flex"><i class="text-xs ri ri-heart-line"></i><span class="my-2">30</span></a>
                                                    <a href="javascript:void(0);" class="text-xs leading-[0] text-gray-500 space-x-2 rtl:space-x-reverse rounded-full bg-gray-100 px-3 py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 inline-flex"><i class="text-xs ri ri-thumb-up-line"></i><span class="my-2">25k</span></a>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-right">
                                            ...
                                            <div class="box">
                                                ...
                                                <p class="text-xs text-gray-500">Invidunt dolor justo gubergren sit voluptua ipsum lorem sanctus, justo dolores dolor dolore stet justo dolor. Eos ipsum rebum diam..</p>
                                                </div>
                                                <div class="box-footer bg-transparent p-4">
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-left">
                                            ...
                                            <div class="box">
                                                ...
                                                <p class="text-xs text-gray-500">Accusam et et stet invidunt at duo, ipsum no takimata est eos magna dolore sed, amet diam sea no diam.</p>
                                                </div>
                                                <div class="box-footer bg-transparent p-4">
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-right">
                                            ...
                                            <div class="box">
                                                ...
                                                <p class="text-xs text-gray-500">Dolore justo lorem vero sed et takimata sit no dolore dolores, elitr eos et dolor consetetur sed sanctus. Ipsum amet elitr lorem clita et dolor. Kasd diam ea dolor sit accusam gubergren no kasd. Ea amet et sed takimata kasd,.</p>
                                                </div>
                                                <div class="box-footer bg-transparent p-4">
                                                <div class="sm:space-y-0 space-y-2 sm:flex items-center justify-between">
                                                    <div class="sm:flex items-center sm:space-x-3 space-x-0 sm:space-y-0 space-y-2 rtl:space-x-reverse">
