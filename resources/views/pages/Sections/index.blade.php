                        ...
                        <div class="ti-modal-body">
                            ...
                            <div class="mb-6">
                                <input type="text" id="input-label" name="Name_Section_En" class="ti-form-input"
                                    ...
                                    value="{{ old('Name_Section_En') }}" autofocus>
                            ...
                            <div class="my-5 py-20">
                                <select class="ti-form-select" data-trigger id="choices-single-groups" multiple
                                    ...
                                    <optgroup label="{{$specialization->getTranslation('Name','ar')}}">
                                        @foreach($teachers->where('Specialization_id', $specialization->id) as $teacher)
                                        <option value="{{$teacher->id}}">{{$teacher->getTranslation('Name','ar')}}
                                        </option>
                                        @endforeach
                                    </optgroup>
                                    @endforeach
...
@section('scripts')
<script>
    function removeTeacher(option) {
        var teacherId = option.parentNode.getAttribute('data-teacher-id');
        var select = document.getElementById('choices-single-groups');
        var selectedOptions = select.selectedOptions;

        for (var i = 0; i < selectedOptions.length; i++) {
            if (selectedOptions[i].getAttribute('data-teacher-id') === teacherId) {
