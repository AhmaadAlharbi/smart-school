                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Radio</h3>
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="space-y-2">
                                            <div class="flex">
                                                ...
                                                <label for="hs-default-radio" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Default radio</label>
                                            </div>

                                            <div class="flex">
                                                <input type="radio" name="hs-default-radio" class="ti-form-radio pointer-events-none" id="hs-checked-radio" checked>
                                                <label for="hs-checked-radio" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Checked radio</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-body">
                                        <div class="space-y-2">
                                            <div class="flex opacity-40">
                                                ...
                                                <label for="hs-disabled-radio" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Disabled radio</label>
                                            </div>

                                            <div class="flex opacity-40">
                                                <input type="radio" name="hs-disabled-radio" class="ti-form-radio" id="hs-disabled-checked-radio" checked disabled>
                                                <label for="hs-disabled-checked-radio" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Disabled checked radio</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex">
                                            ...
                                            <label for="hs-radio-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Apple</label>
                                        </div>

                                        <div class="flex">
                                            <input type="radio" name="hs-radio-group" class="ti-form-radio" id="hs-radio-group-2">
                                            <label for="hs-radio-group-2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Pear</label>
                                        </div>

                                        <div class="flex">
                                            <input type="radio" name="hs-radio-group" class="ti-form-radio" id="hs-radio-group-3">
                                            <label for="hs-radio-group-3" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Orange</label>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="flex">
                                            ...
                                            <label for="hs-radio-vertical-group-1" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Apple</label>
                                        </div>

                                        <div class="flex">
                                            <input type="radio" name="hs-radio-vertical-group" class="ti-form-radio" id="hs-radio-vertical-group-2">
                                            <label for="hs-radio-vertical-group-2" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Pear</label>
                                        </div>

                                        <div class="flex">
                                            <input type="radio" name="hs-radio-vertical-group" class="ti-form-radio" id="hs-radio-vertical-group-3">
                                            <label for="hs-radio-vertical-group-3" class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Orange</label>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="relative flex items-start">
                                        ...
                                        <span id="hs-radio-delete-description" class="block text-sm text-gray-600">Notify me when this action happens.</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="relative flex items-start">
                                        ...
                                        <span id="hs-radio-archive-description" class="block text-sm text-gray-600">Notify me when this action happens.</span>
                                        </label>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-span-12 lg:col-span-4">
                                ...
                                <div class="box-body">
                                    ...
                                    <label class="max-w-xs flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary">
                                        ...
                                        <span class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Default radio</span>
                                    </label>
                                    ...
                                    <label class="max-w-xs flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary">
                                        ...
                                        <span class="text-sm text-gray-500 ltr:ml-2 rtl:mr-2">Checked radio</span>
                                    </label>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                ...
                                <div class="box-body">
                                    <div class="grid sm:grid-cols-2 gap-2">
                                    <label class="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary">
                                        <span class="text-sm text-gray-500">Default radio</span>
                                    ...
                                    <label class="flex p-3 w-full bg-white border border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary">
                                        <span class="text-sm text-gray-500">Checked radio</span>
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="ti-list-group bg-white border text-gray-800">
                                        ...
                                        <label for="hs-list-group-item-radio-1" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Chris Lynch
                                        </label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group bg-white border text-gray-800">
                                        ...
                                        <label for="hs-list-group-item-radio-2" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Maria Guan
                                        </label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group bg-white border text-gray-800">
                                        ...
                                        <label for="hs-list-group-item-radio-3" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Bob Arum
                                        </label>
                                        </div>
                                    </li>
                            ...
                            <div class="col-span-12 lg:col-span-6">
                                ...
                                <div class="box-body">
                                    ...
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 ltr:sm:-ml-px rtl:sm:-mr-px sm:mt-0 ltr:sm:first:rounded-tr-none rtl:sm:first:rounded-tl-none ltr:sm:first:rounded-bl-sm rtl:sm:first:rounded-br-sm ltr:sm:last:rounded-bl-none rtl:sm:last:rounded-br-none ltr:sm:last:rounded-tr-sm rtl:sm:last:rounded-tl-sm">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-1" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Chris Lynch
                                        </label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 ltr:sm:-ml-px rtl:sm:-mr-px sm:mt-0 ltr:sm:first:rounded-tr-none rtl:sm:first:rounded-tl-none ltr:sm:first:rounded-bl-sm rtl:sm:first:rounded-br-sm ltr:sm:last:rounded-bl-none rtl:sm:last:rounded-br-none ltr:sm:last:rounded-tr-sm rtl:sm:last:rounded-tl-sm">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-2" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Maria Guan
                                        </label>
                                        </div>
                                    </li>
                                    ...
                                    <li class="ti-list-group gap-x-2.5 bg-white border text-gray-800 ltr:sm:-ml-px rtl:sm:-mr-px sm:mt-0 ltr:sm:first:rounded-tr-none rtl:sm:first:rounded-tl-none ltr:sm:first:rounded-bl-sm rtl:sm:first:rounded-br-sm ltr:sm:last:rounded-bl-none rtl:sm:last:rounded-br-none ltr:sm:last:rounded-tr-sm rtl:sm:last:rounded-tl-sm">
                                        ...
                                        <label for="hs-horizontal-list-group-item-radio-3" class="ltr:ml-2 rtl:mr-2 block w-full text-sm text-gray-600">
                                            Bob Arum
                                        </label>
                                        </div>
                                    </li>
