                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 text-2xl font-medium"> Cart</h3>
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-9">
                                ...
                                <div class="box-body p-0">
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        <thead class="">
                                        <tr>
                                            <th scope="col" class="!text-sm !p-4 !text-gray-800">Product</th>
                                            <th scope="col" class="!text-sm !p-4 !text-gray-800">Price (Each) </th>
                                            <th scope="col" class="!text-sm !p-4 !text-gray-800">QNTY</th>
                                            <th scope="col" class="!text-sm !p-4 !text-gray-800">Discount</th>
                                            <th scope="col" class="!text-sm !p-4 !text-gray-800">Total</th>
                                            <th scope="col" class="!text-end !text-sm !p-4 !text-gray-800">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/1.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Black Heals For Women</span>
                                                <span class="block text-sm text-gray-600">Brown Color</span>
                                                <span class="block text-sm text-gray-600">Size : M</span>
                                            </div>
                                            </td>
                                            <td>$999</td>
                                            <td>
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/7.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Sun Glasses</span>
                                                <span class="block text-sm text-gray-600">White Color</span>
                                                <span class="block text-sm text-gray-600">Adjustable</span>
                                            </div>
                                            </td>
                                            <td>$699</td>
                                            <td>
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/10.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Leather Wallet For Grils</span>
                                                <span class="block text-sm text-gray-600">White Color</span>
                                            </div>
                                            </td>
                                            <td>$150</td>
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/5.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Dolor Rose Frangrance Perfume</span>
                                                <span class="block text-sm text-gray-600">Jasmine Fragrance</span>
                                                <span class="block text-sm text-gray-600">500 ML</span>
                                            </div>
                                            </td>
                                            <td>$299</td>
                                            <td>
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/4.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Dolor Wireless Airpods </span>
                                                <span class="block text-sm text-gray-600">White color</span>
                                                <span class="block text-sm text-gray-600">Bluetooth</span>
                                            </div>
                                            </td>
                                            <td>$499</td>
                                            <td>
                                        ...
                                        <tr class="cart-box">
                                            <td class="flex">
                                            <img class="avatar avatar-lg rounded-sm bg-gray-100 p-1" src="{{asset('build/assets/img/ecommerce/products/2.png')}}" alt="Image Description">
                                            <div class="ltr:ml-3 rtl:mr-3">
                                                <span class="block text-sm font-semibold text-gray-800 max-w-[200px] truncate">Dolar Tshirt For Men</span>
                                                <span class="block text-sm text-gray-600">Blue color</span>
                                                <span class="block text-sm text-gray-600">Size : M</span>
                                            </div>
                                            </td>
                                            <td>$599</td>
                                ...
                                <div class="box-body p-0">
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head">
                                        ...
                                        <tr>
                                            ...
                                            <span class="text-sm text-gray-600">3,458</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <span class="text-sm text-gray-600">Over All Discount</span>
                                            </td>
                                            <td class="font-medium">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-medium">
                                            <span class="text-sm text-gray-600">0 (Free)</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            <span class="text-sm text-gray-600">Vatt</span>
                                            </td>
                                            <td class="font-medium">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-medium">
                                            <span class="text-sm font-semibold text-gray-800">$40,020</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
