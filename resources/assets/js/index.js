...
var element = document.getElementById("sales-chart2");
if (element !== null) {
  element.innerHTML = "";
  var options2 = {
    series: [
  ...
  var spark2 = new ApexCharts(element, options2);
  spark2.render();
}


var element = document.getElementById("sales-chart3");
if (element !== null) {
  element.innerHTML = "";
  var options3 = {
    series: [
...
var element = document.getElementById("sales-chart4");
if (element !== null) {
  element.innerHTML = "";
  var options4 = {
    series: [
...
export function sparkchart(myVarVal) {
...
export function sparkchart2(myVarVal) {
  function rgbToHex(r, g, b) {
    return "#" + ((1 << 24) | (r << 16) | (g << 8) | b).toString(16).slice(1);
  }
...
export function sparkchart3(myVarVal) {
  function rgbToHex(r, g, b) {
    return "#" + ((1 << 24) | (r << 16) | (g << 8) | b).toString(16).slice(1);
  }
...
export function sparkchart4(myVarVal) {
  function rgbToHex(r, g, b) {
    return "#" + ((1 << 24) | (r << 16) | (g << 8) | b).toString(16).slice(1);
  }
